...
bool coin::LoadImg(string path, SDL_Renderer* screen) {   // giống character ?
...
void coin::set_clips() {    // giống character ?
...
void coin::Render(SDL_Renderer *screen) {  // khac character 1 xiu?
    if (come_back_time == 0) {
        rect.x = x_pos - map_x;
        rect.y = y_pos - map_y;
        frame++;
...
void coin::CheckToMap(Map &map_data) {
